...
// @name         AntiCommie map
// @version      1.0
// @description  PixelCanvas.io minimap for Ancapixel/Anti-commies, do your duty!
// @author       nisano and !Asuma
...
<div id="minimapbg">
  <div class="posy" id="posyt">
    ...
    <div id="minimap-config">
      <span class="map-clickable" id="hide-map">Esconder</span>
      |
      <span class="map-clickable" id="follow-mouse">Seguir mouse</span>
      |
      <span class="map-clickable" id="toggle-grid">Grelha</span>
      |
      Zoom:
